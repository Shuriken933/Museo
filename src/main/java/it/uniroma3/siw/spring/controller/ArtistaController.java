...
public class ArtistaController {
	...
	public String modifyArtista(@ModelAttribute("artista") Artista artista, Model model, BindingResult bindingResult) {
		...
		/*System.out.println("ID dell'artista: " + artista.getId());
		System.out.println("nome: " + artista.getNome());
		System.out.println("cognome: " + artista.getCognome());
		System.out.println("luogo di nascita: " + artista.getLuogoDiNascita());
		System.out.println("data di nascita: " + artista.getDataDiNascita());
		System.out.println("luogo di morte: " + artista.getLuogoDiMorte());
		System.out.println("data di morte: " + artista.getDataDiMorte());
		System.out.println("biografia: " + artista.getBiografia());
		System.out.println("nazionalità: " + artista.getNazionalita());*/
